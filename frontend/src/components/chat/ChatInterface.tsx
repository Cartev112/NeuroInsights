...
export function ChatInterface() {
  ...
  return (
    <div className="relative flex flex-1 min-h-full flex-col overflow-hidden rounded-3xl border border-border/40 bg-card/40 shadow-[0_30px_80px_-40px_rgba(124,58,237,0.45)] backdrop-blur">
